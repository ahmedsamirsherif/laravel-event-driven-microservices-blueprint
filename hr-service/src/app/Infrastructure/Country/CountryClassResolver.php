...
final class CountryClassResolver
{
     ...
     * @param string          $suffix     Class suffix (e.g., "Fields")
     ...
     * Examples:
     *   buildClassName('USA', 'Fields')      -> App\Domain\Country\USA\USAFields
     *   buildClassName('DEU', 'Fields')  -> App\Domain\Country\DEU\DEUFields
     */
